...
static MenuDef menuDefContext[] = {
    ...
    { _TRN("Add chapter"),                  DEKBELCODE_ADDCHAPTER,             MF_REQ_DISK_ACCESS | MF_REQ_ALLOW_COPY },
    { _TRN("Add subchapter"),               DEKBELCODE_ADDSUBCHAPTER,          MF_REQ_DISK_ACCESS | MF_REQ_ALLOW_COPY },
    { _TRN("Add paragraph"),                DEKBELCODE_ADDPARAGRAPH,           MF_REQ_DISK_ACCESS | MF_REQ_ALLOW_COPY },
    { _TRN("Set page number"),              DEKBELCODE_STARTAUTOPAGINATION,    MF_REQ_DISK_ACCESS },
...
void OnContextMenu(WindowInfo* win, int x, int y) {
    ...
    if (!win->currentTab->selectionOnPage) {
        ...
        win::menu::SetEnabled(popup, DEKBELCODE_ADDCHAPTER, false);
        win::menu::SetEnabled(popup, DEKBELCODE_ADDSUBCHAPTER, false);
        win::menu::SetEnabled(popup, DEKBELCODE_ADDPARAGRAPH, false);
    }
    ...
    switch (cmd) {
        ...
        case DEKBELCODE_EDITCITATION:
            ...
            ReloadDocument(win);
            break;
        case DEKBELCODE_STARTAUTOPAGINATION:
        case DEKBELCODE_ADDVOLUMETITLE:
        case DEKBELCODE_ADDBOOKTITLE:
        case DEKBELCODE_ADDCHAPTER:
        case DEKBELCODE_ADDSUBCHAPTER:
        case DEKBELCODE_ADDPARAGRAPH:
            DoBel(win, cmd);
            break;
    }
