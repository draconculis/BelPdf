    ...
    public partial class RawCitationEditor : Form
    {
        ...
        private void Button_Close_Click(object sender, EventArgs e)
        {
            if (HasUnsavedChanges)
                if (MessageBox.Show($"Your changes are not saved to database.{Environment.NewLine}Continue and discard changes?", "Unsaved changes", MessageBoxButtons.YesNo) == DialogResult.No)
                    return;
