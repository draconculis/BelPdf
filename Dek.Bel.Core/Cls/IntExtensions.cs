...
namespace Dek.Cls
{
    public static class IntExtensions
    {
        ...
        public static int RomanToInteger(string me)
        {
            int number = 0;
            string roman = me.ToUpper();
        ...
        public static string ToRomanString(this int me, bool toLower = false)
        {
            ...
            return toLower ? romanNumeral.ToLower() : romanNumeral;
        }
    }
}
